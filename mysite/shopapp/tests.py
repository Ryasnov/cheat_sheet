...
class OrderDetailViewTestCase(TestCase):
    @classmethod
    def setUpClass(cls):
        cls.user = User.objects.create_user(username="test username", password="qwerty")
...
class ProductsExportViewTestCase(TestCase):
    fixtures = ["products-fixture.json", "users-fixture"]
...
class OrderExportViewTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user = User.objects.create_user(
            username="test_1", password="test_1", is_staff="1", is_superuser="1"
        )
